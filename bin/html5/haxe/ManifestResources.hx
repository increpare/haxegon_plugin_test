...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Config):Void {
		...
		data = '{"name":null,"assets":"aoy4:pathy15:data%2Ficon.pngy4:sizei143966y4:typey5:IMAGEy2:idR1y7:preloadtgoR0y34:data%2Fhow%20to%20add%20assets.txtR2i6664R3y4:TEXTR5R7R6tgh","version":2,"libraryArgs":[],"libraryType":null}';
